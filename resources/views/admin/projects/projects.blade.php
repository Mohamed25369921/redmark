                        ...
                        <table class="table" id="exportexample">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-25p">{{trans('home.category')}}</th>
                            ...
                            <tbody>
                                @foreach($projects as $project)
                                    <tr id="{{$project->id}}">
                                        ...
                                        <td><a href="{{ route('projects.edit', $project->id) }}">{{(app()->getLocale() == 'en')?$project->category->name_en:$project->category->name_ar}}</a></td>
                                         <td>
                                            <a href="{{ route('projects.edit', $project->id) }}">
                                                @if($project->image)
                                                    <img src="{{url('/uploads/projects/resize200')}}/{{$project->image}}" width="70">
                                                @else
