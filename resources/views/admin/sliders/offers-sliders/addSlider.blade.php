...
<title>{{trans('home.add_offers_slider')}}</title>
@section('content')
            ...
            <div class="col-sm-12 col-xl-12 col-lg-12">
                <div class="card custom-card overflow-hidden">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => 'offers-sliders.store', 'data-toggle'=>'validator', 'files'=>'true']) !!}
                            <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <a href="{{url('/admin/offers_sliders')}}"><button type="button" class="btn btn-danger mr-1"><i class="icon-trash"></i> {{trans('home.cancel')}}</button></a>
                                </div>
