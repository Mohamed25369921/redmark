...
<title>{{trans('home.edit_offers_sliders')}}</title>
@section('content')
            ...
            <div class="col-sm-12 col-xl-12 col-lg-12">
                <div class="card custom-card overflow-hidden">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['method'=>'PATCH','url' => 'admin/offers-sliders/'.$slider->id, 'data-toggle'=>'validator', 'files'=>'true']) !!}
                            <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                @if($slider->image)
                                    <div class="form-group  col-md-12">
                                        <img src="{{url('\uploads\sliders\offers-sliders\resize200')}}\{{$slider->image}}" width="350" height="150">                                    </div>
                                    </div>
                                @endif
