        ...
        <div class="page-header">
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{trans('home.menus')}}</li>
                </ol>
            </div>
            <div class="btn btn-list">
                <a href="{{url('admin/menus/create')}}"><button class="btn ripple btn-primary"><i class="fas fa-plus-circle"></i> {{trans('home.add')}}</button></a>
        ...
        <div class="row">
            <div class="col-sm-12 col-xl-12 col-lg-12">
                <div class="card custom-card overflow-hidden">
                    <div class="card-body">
                        <div>
                            <h6 class="card-title mb-1">{{trans('home.menus')}}</h6>
                        ...
                        <table class="table" id="exportexample">
                            ...
                            <tbody>
                                @foreach($menus as $menu)
                                    <tr id="{{$menu->id}}">
                                        <td> <input type="checkbox" name="checkbox"  class="tableChecked" value="{{$menu->id}}" /> </td>
