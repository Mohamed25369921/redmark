    ...
    <div class="page-header">
        <div>
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{trans('home.add_region')}}</li>
            </ol>
        </div>
    </div>
    <!-- End Page Header -->

    {!! Form::open(['route' => 'regions.store', 'data-toggle'=>'validator', 'files'=>'true']) !!}
    <!-- Row-->
    <div class="row">
        <div class="col-sm-12 col-xl-12 col-lg-12">
            <div class="card custom-card overflow-hidden">
                ...
                <div class="card-body">
                    <div>
                        <h6 class="card-title mb-1">{{trans('home.add_region')}}</h6>
                        <hr>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label class="ckbox">
                                <input name="available_units" value="1" type="checkbox"><span class="tx-13">{{trans('home.available_units')}}</span>
                            </label>
                        </div>
