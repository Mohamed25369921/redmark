...
class TestimonialController extends Controller
{
    ...
    {
        $members = Testimonial::get();
        return view('admin.testimonials.testimonials',compact('members'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile("img")) {
           ...
           // $destinationPath = base_path() . '/uploads/'; // upload path
            ...
            if (!File::exists(dirname($resize200))) {
                File::makeDirectory(dirname($resize200), 0755, true);
            }
            if (!File::exists(dirname($resize800))) {
                File::makeDirectory(dirname($resize800), 0755, true);
            }
        ...
        $add->save();
        return redirect('admin/members')->with('success',trans('home.your_item_updated_successfully'));
    }
    ...
    public function edit($id)
    {
        ...
        if($member){
            return view('admin.testimonials.editTestimonial',compact('member'));
        }else{
            abort('404');
        }
    }
